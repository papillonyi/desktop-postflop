  ...
  <div class="flex">
    <div>
      <div class="flex my-1 items-center">
        ...
        <button
          :disabled="
            isTreeBuilding || store.isSolverRunning || store.isFinalizing
          "
              ...
              <div class="px-1 py-0.5 text-justify">
                ...
                <ul class="pl-6 list-disc">
                  <li class="mt-1">
                    ...
                    integer mode uses only about half the memory of the 32-bit
                    FP mode.
                  </li>
                  <li class="mt-1">
                    Performance: Depends on the environment. The 32-bit FP mode
                    requires fewer execution instructions than the 16-bit
                    integer mode. However, memory reads and writes can become a
                    bottleneck in highly multithreaded environments, and in such
                    situations the 16-bit integer mode may provide better
                    performance.
                  </li>
                  <li class="mt-1">
                    Significant digits: 32-bit FP (about 7 digits) > 16-bit
                    integer (about 4 digits). The 16-bit integer mode is not
                    suitable for satisfying an exploitability target of less
                    than 0.1%.
                  </li>
                </ul>
              </div>
